...
Copy the file ``dime_mcmc.m`` from this repo somwhere and add them to you matlab path. If you want to run the tutorial, you also need the files ``create_dime_test_func.m`` and ``dime_test_func_marginal_pdf.m``.
